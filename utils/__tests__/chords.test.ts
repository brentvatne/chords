...
function generateExtensionCombinations(
...
describe("getChordInfo", () => {
  ...
  test("returns correct notes for minor chords with extensions", () => {
    const cases: [ChordSelection, string[]][] = [
      ...
      [
        { triad: "minor", extensions: ["m7", "6"] },
        ["C", "Eb", "G", "A", "Bb"],
      ],
      [
        { triad: "minor", extensions: ["m7", "9"] },
        ["C", "Eb", "G", "Bb", "D"],
      ],
      [{ triad: "minor", extensions: ["6", "9"] }, ["C", "Eb", "G", "A", "D"]],
      [
        { triad: "minor", extensions: ["m7", "6", "9"] },
        ["C", "Eb", "G", "A", "Bb", "D"],
      ],
    ];
