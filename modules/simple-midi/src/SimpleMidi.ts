...
export class MidiKeyboard {
  ...
  addDeviceListener(
    ...
    if (onConnected) {
      subscriptions.push(
        this.module.addListener('onDeviceConnected', ({ deviceId, deviceName }) => {
    ...
    if (onDisconnected) {
      subscriptions.push(
        this.module.addListener('onDeviceDisconnected', ({ deviceId, deviceName }) => {
...
export { ConnectionInfo, MidiControllers, MidiDevice, MidiNotes, SimpleMidiModule };
